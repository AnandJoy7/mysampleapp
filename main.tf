...
provider "kubernetes" {
  host                   = module.eks-nodes-spw.eks_cluster_endpoint
  cluster_ca_certificate = base64decode(module.eks-nodes-spw.eks_cluster_certificate_authority_data)
  token                  = module.eks-nodes-spw.eks_cluster_token
}
